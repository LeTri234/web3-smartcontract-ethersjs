...
const commonStyles =
  "min-h-[70px] sm:px-0 px-2 sm:min-w-[120px] flex justify-center items-center border-[0.5px] border-gray-400 text-white text-sm font-light";
      ...
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start flex-col mf:mr-10">
          ...
          <div className="grid sm:grid-cols-3 grid-cols-2 w-full mt-10">
            ...
            <div className={commonStyles}>Sercurity</div>
            <div className={`rounded-tr-2xl ${commonStyles}`}>Sercurity</div>
        ...
        <div className="flex flex-col flex-1 items-center justify-start w-full md:mt-0 mt-10">
          ...
          <div className="p-5 sm:w-95 w-full flex flex-col justify-start items-center blue-glassmorphism ">
            <Input
